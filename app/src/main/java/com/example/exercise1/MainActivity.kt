...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        private fun calculate(view: View) {
            var carPrice = findViewById<EditText>(R.id.txtCP).text.toString()
            var downPayment = findViewById<EditText>(R.id.txtDP).text.toString()
            var loanPeriod = findViewById<EditText>(R.id.txtLP).text.toString()
            var interestRate = findViewById<EditText>(R.id.txtIP).text.toString()
